    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! Insertion Sort is particularly efficient for arrays that are already mostly sorted, as it inserts new elements into their correct positions with minimal comparisons and shifts.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: Insertion Sort is efficient for maintaining a sorted array when new elements are frequently added, especially when the array is already nearly sorted.";
				feedback.className = "wrong";
			}
        });
    } else {

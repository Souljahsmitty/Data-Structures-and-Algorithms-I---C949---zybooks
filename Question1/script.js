    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! A data structure is a way of organizing, storing, and performing operations on data.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B: A data structure is a way of organizing, storing, and performing operations on data.";
                feedback.className = "wrong";
            }

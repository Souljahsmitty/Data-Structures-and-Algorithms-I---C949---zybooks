    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! Sorting the topSales array ensures that the highest sales are always at the front, facilitating the identification of the top performers.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: Sorting the topSales array ensures that the highest sales are always at the front, facilitating the identification of the top performers.";
				feedback.className = "wrong";
			}
        });
    } else {

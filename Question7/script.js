    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A hash table is used for storing unordered items by mapping them to a location using a hashing function.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: A hash table is used for storing unordered items by mapping them to a location using a hashing function.";
				feedback.className = "wrong";
			}
        });
    } else {

    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Well-defined inputs and outputs ensure that an algorithm operates predictably and correctly, processing specified inputs to produce expected outputs.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Well-defined inputs and outputs ensure that an algorithm operates predictably and correctly, processing specified inputs to produce expected outputs.";
				feedback.className = "wrong";
			}
        });
    } else {

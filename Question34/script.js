    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! The number of elements in the topSales array is determined by its length property, which is initialized to 5. The length of the allSalespersons array can vary and is not necessarily equal to the length of the topSales array.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: The number of elements in the topSales array is determined by its length property, which is initialized to 5. The length of the allSalespersons array can vary and is not necessarily equal to the length of the topSales array.";
				feedback.className = "wrong";
			}
        });
    } else {

    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! In a Data Flow Diagram, vertices represent the different processes or data stores within the system.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: In a Data Flow Diagram, vertices represent the different processes or data stores within the system.";
				feedback.className = "wrong";
			}
        });
    } else {

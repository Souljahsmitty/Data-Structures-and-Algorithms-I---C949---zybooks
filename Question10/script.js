document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "C") {
                feedback.textContent = "✔ Correct! A binary search tree is best for efficiently searching in a large, ordered dataset.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is C: A binary search tree is best for efficiently searching in a large, ordered dataset.";
                feedback.className = "wrong";
            }
        });
    } else {
    ...
    if (nextButton) {
        nextButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question11/index.html";
        });
    } else {

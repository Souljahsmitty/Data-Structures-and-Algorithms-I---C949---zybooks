    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "D") {
                feedback.textContent = "✔ Correct! Data structures allow operations such as accessing, updating, inserting, and removing data. These operations help manage and manipulate stored data efficiently.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is D: Data structures allow operations such as accessing, updating, inserting, and removing data. These operations help manage and manipulate stored data efficiently.";
                feedback.className = "wrong";
            }

    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! An array is a data structure where elements are stored in an ordered list and accessed by an index.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: An array is a data structure where elements are stored in an ordered list and accessed by an index.";
				feedback.className = "wrong";
			}

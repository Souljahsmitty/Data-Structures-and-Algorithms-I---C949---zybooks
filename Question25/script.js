    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! When appending an element to an array, if the array is full, it increases its size (often by doubling), and assigns the new item to the next available index.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: When appending an element to an array, if the array is full, it increases its size (often by doubling), and assigns the new item to the next available index.";
				feedback.className = "wrong";
			}
        });
    } else {

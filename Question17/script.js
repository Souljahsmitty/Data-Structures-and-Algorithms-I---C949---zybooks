    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Feasibility in an algorithm means that it can be executed with the available resources, ensuring practical applicability.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: Feasibility in an algorithm means that it can be executed with the available resources, ensuring practical applicability.";
				feedback.className = "wrong";
			}
        });
    } else {

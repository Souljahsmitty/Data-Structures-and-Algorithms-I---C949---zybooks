    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! An array is suitable for tracking the top five salespersons because it allows for efficient indexing and fixed-size storage.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: An array is suitable for tracking the top five salespersons because it allows for efficient indexing and fixed-size storage.";
				feedback.className = "wrong";
			}
        });
    } else {

document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Data Flow Diagrams help businesses identify inefficiencies in their processes by providing a clear visual representation of data movement, enabling better analysis and optimization.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Data Flow Diagrams help businesses identify inefficiencies in their processes by providing a clear visual representation of data movement, enabling better analysis and optimization.";
				feedback.className = "wrong";
			}
        });
    } else {
    ...
    if (backButton) {
        backButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question22/index.html";
        });
    } else {
    ...
    if (nextButton) {
        nextButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question24/index.html";
        });
    } else {

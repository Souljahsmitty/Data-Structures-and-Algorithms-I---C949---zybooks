document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Inserting at the end of an array can be slower than in a linked list when resizing is needed, as arrays may require allocating new memory and copying existing elements.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: Inserting at the end of an array can be slower than in a linked list when resizing is needed, as arrays may require allocating new memory and copying existing elements.";
				feedback.className = "wrong";
			}
        });
    } else {
    ...
    if (backButton) {
        backButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question26/index.html";
        });
    } else {

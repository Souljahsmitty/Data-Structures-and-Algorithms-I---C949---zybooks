    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! An algorithm is a set of commands followed for problem-solving operations.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: An algorithm is a set of commands followed for problem-solving operations.";
				feedback.className = "wrong";
			}
        });
    } else {

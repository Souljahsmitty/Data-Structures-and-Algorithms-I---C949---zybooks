    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! Algorithms define a structured approach to solving problems.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B.Algorithms define a structured approach to solving problems.";
                feedback.className = "wrong";
            }
        });
    } else {

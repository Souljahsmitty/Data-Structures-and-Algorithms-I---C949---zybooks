    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! All of the above statements highlight key differences between appending items to arrays and linked lists.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is D: All of the above statements highlight key differences between appending items to arrays and linked lists.";
				feedback.className = "wrong";
			}
        });
    } else {

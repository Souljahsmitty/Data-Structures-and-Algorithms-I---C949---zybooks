document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! A heap is a special type of tree where parent nodes have a specific ordering relative to their children.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B: A heap is a special type of tree where parent nodes have a specific ordering relative to their children.";
                feedback.className = "wrong";
            }
        });
    } else {
    ...
    if (backButton) {
        backButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question7/index.html";
        });
    } else {
    ...
    if (nextButton) {
        nextButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question9/index.html";
        });
    } else {

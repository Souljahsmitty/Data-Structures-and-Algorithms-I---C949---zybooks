document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! A correct algorithm must have finiteness, meaning it eventually terminates. Algorithms cannot have infinite loops unless designed for continuous execution.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: A correct algorithm must have finiteness, meaning it eventually terminates. Algorithms cannot have infinite loops unless designed for continuous execution.";
				feedback.className = "wrong";
			}
        });
    } else {
    ...
    if (backButton) {
        backButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question12/index.html";
        });
    } else {

document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! The DisplayTopFiveSalespersons algorithm always displays 5 elements. If allSalespersons contains only 3 elements, the remaining 2 elements in the topSales array will retain their initial values (no name and negative sales).";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: The DisplayTopFiveSalespersons algorithm always displays 5 elements. If allSalespersons contains only 3 elements, the remaining 2 elements in the topSales array will retain their initial values (no name and negative sales).";
				feedback.className = "wrong";
			}
        });
    } else {
    ...
    if (backButton) {
        backButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question31/index.html";
        });
    } else {
    ...
    if (nextButton) {
        nextButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question33/index.html";
        });
    } else {

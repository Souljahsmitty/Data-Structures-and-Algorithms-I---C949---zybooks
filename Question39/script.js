document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Appending an element to an array may require shifting elements if the array is full and needs resizing, whereas linked lists do not require shifting elements during insertion.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: Arrays may require shifting elements during insertion, especially if resizing is needed, while linked lists allow direct insertion without shifting.";
				feedback.className = "wrong";
			}
        });
    } else {
    ...
    if (nextButton) {
        nextButton.addEventListener("click", function() {
            ...
            window.location.href = "../Question40/index.html";
        });
    } else {

    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A Data Flow Diagram (DFD) helps visualize how data moves through a system, providing a clear representation of processes and data flow.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: A Data Flow Diagram (DFD) helps visualize how data moves through a system, providing a clear representation of processes and data flow.";
				feedback.className = "wrong";
			}
        });
    } else {
